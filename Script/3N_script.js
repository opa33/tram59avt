...
function handleClick() {
  ...
  var elementsToHide = document.querySelectorAll(
    ".marshrut, .time_pos, .timer, .qr, .ost, .control_box, .mini_line, .mini_line2, mini_line3, .null_shap, zo, .schedule_new, .proezdnoy_new, .button, .new_control"
  );
...
function handleClick2() {
  ...
  var elementsToHide = document.querySelectorAll(
    ".marshrut, .time_pos, .timer, .qr, .ost, .control_box, .mini_line, .mini_line2, mini_line3, .null_shap, zo, .profile_new, .proezdnoy_new, .profile_new2, .button, .new_control"
  );
  elementsToHide.forEach(function (element) {
    element.style.display = "none";
...
function handleClick3() {
  ...
  var elementsToHide = document.querySelectorAll(
    ".marshrut, .time_pos, .timer, .qr, .ost, .control_box, .mini_line, .mini_line2, mini_line3, .null_shap, zo, .profile_new, .schedule_new, .profile_new2, .button, .new_control"
  );
  elementsToHide.forEach(function (element) {
    element.style.display = "none";
...
function handleClick4() {
  ...
  var elementsToHide = document.querySelectorAll(
    ".marshrut, .time_pos, .timer, .qr, .ost, .control_box, .mini_line, .mini_line2, mini_line3, .null_shap, zo"
  );
  elementsToHide.forEach(function (element) {
...
var exit = document.querySelectorAll(
  ".arrow_img, .left_menu_exit, .fig_2, .fig_3, .fig_4"
);
...
var all_hide = document.querySelectorAll(
  ".marshrut, .time_pos, .timer, .qr, .new_control, .ost, .control_box, .button, .scan_QR_fon, .num_QR_box, .card_box, .copy_img, .right_up_img, .history_box"
);
var now_order = document.querySelectorAll(
  ".marshrut, .time_pos, .timer, .qr, .new_control, .ost, .control_box"
);
var Active_menunow_img = document.getElementById(
  "https://neviie.github.io/Assets/Active_menunow.png"
);
...
function noactive() {
  ...
  var now_img = document.getElementById(
    "https://neviie.github.io/Assets/Active_menunow.png"
  );
  ...
  all_leftmenu_buttons.forEach((button) => {
    ...
    history_img.src =
      "https://neviie.github.io/Assets/Noactive_menuhistory.png";
...
historyleft.addEventListener("click", () => {
  ...
  function getRandomDate() {
    ...
    var formattedDate = randomDate.toLocaleDateString("ru-RU", {
      day: "2-digit",
      month: "2-digit",
      year: "numeric",
    });
    var formattedTime = randomDate.toLocaleTimeString("ru-RU", {
      hour: "2-digit",
      minute: "2-digit",
    });
  ...
  for (var i = 0; i < numDivs; i++) {
    ...
    greenbusBoxNum.textContent = getRandomNumber(
      1,
      80,
      [2, 31, 42, 43, 66, 72, 76, 78, 79]
    );
...
document.addEventListener("DOMContentLoaded", function () {
  function cloneControlElements() {
    ...
    if (!isNaN(passenValue) && passenValue >= 2) {
      ...
      for (let i = 1; i < passenValue; i++) {
        ...
        controlDiv.parentElement.insertBefore(
          clone,
          controlDiv.nextElementSibling
        );
      }
    }
  ...
  document
    .getElementById("passen")
    .addEventListener("DOMSubtreeModified", cloneControlElements);
});
